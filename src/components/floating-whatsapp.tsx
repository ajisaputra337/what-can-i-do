...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="wa-pulse fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[oklch(0.74_0.18_152)] text-white shadow-[0_8px_24px_-4px_oklch(0.74_0.18_152/0.5)] transition-transform hover:scale-110"
    >
      <svg
